...
<div class="w3-main w3-container" style="margin-left:270px;margin-top:117px;">
    ...
    <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
        <h1 class="w3-xxlarge">Exclusão de Exame</h1>
            ...
            <div class="w3-code cssHigh notranslate">
				...
				?>
								<div class="w3-container w3-blue">
									<h2>Exclusão do Exame || Código = [<?php echo $row['CodDisciplina']; ?>]</h2>
								</div>
								<form class="w3-container" action="discExcluir_exe.php" method="post" onsubmit="return check(this.form)">
									...
									<p>
									<label class="w3-text-deep-black"><b>Exame: </b> <?php echo $row['NomeDisc']; ?> </label></p>
									<p>
									<label class="w3-text-deep-black"><b>Periodicidade: </b><?php echo $row['Ementa']; ?></label></p>
									<p>
									<input type="submit" value="Confirma exclusão?" class="w3-btn w3-red" >
									<input type="button" value="Cancelar" class="w3-btn w3-teal" onclick="window.location.href='discListar.php'"></p>
								</form>
			<?php 
							}
						}
